      ...
      <div className="reviews">
        ...
        <div className="review">
          ...
          <div className="body-review">
            ...
            <div className="desc-review">
              ...
              selection of drinks and a handful of hand food too!! The staff are
              super nice. Cafe is clean! Such an 5 out of 5 location!!
            </div>
          </div>
        </div>
        <div className="review">
        ...
        <div className="review">
          ...
          <div className="body-review">
            ...
            <div className="desc-review">
              This is an amazing place to come and enjoy a delicious beverage or
              some of their great food. It's a comfortable environment with
              friendly staff.
            </div>
          </div>
        </div>
